  ...
  return (
    <div className="space-y-2">
      <button
        ...
        className="w-full flex items-center justify-center gap-2 py-2.5 px-3 border border-gray-200 rounded-md hover:bg-gray-50 transition text-sm text-[#1F2937]"
